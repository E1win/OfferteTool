...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260518165934_AddTenderInvitation")]
    partial class AddTenderInvitation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.SecurityAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TargetOrganisationId", "OccurredAtUtc");
            ...
            modelBuilder.Entity("Domain.Entities.TenderChangeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SupplierVisibleMessage")
                        .IsRequired()
                        .HasMaxLength(4096)
                        .HasColumnType("character varying(4096)");
                    ...
                    b.HasIndex("TenderId", "ChangedAtUtc");

                    b.ToTable("TenderChangeLogs");
                });

            modelBuilder.Entity("Domain.Entities.TenderInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SupplierOrganisationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenderId", "SupplierOrganisationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.TenderInvitation", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Organisation", "SupplierOrganisation")
                        .WithMany()
